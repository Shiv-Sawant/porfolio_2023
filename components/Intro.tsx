...
const Intro = () => {
    ...
    return (
        <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
            <div className='flex items-center justify-center'>
                <div className='relative'>
                    <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ type: "tween", duration: 0.2 }}>
                        <Image src={five} alt='shiv_sawant' width='192' height='192' quality='95' priority={true} className='h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shadow-xl' />
                    </motion.div>
            ...
            >
                <span className="font-bold">Hello, I'm Shiv.</span> I'm a{" "}
            ...
            >
                ...
                <a
                    ...
                    href="https://www.linkedin.com/in/shiv-sawant-3bbb26229/"
                    target="_blank"
                >
                    <BsLinkedin />
                </a>
                ...
                <a
                    ...
                    href="https://github.com/Shiv-Sawant"
                    target="_blank"
                >
                    <FaGithubSquare />
                </a>
